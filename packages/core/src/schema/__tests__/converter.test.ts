...
describe('convertZodToJsonSchema', () => {
  ...
  describe('fallback behavior and x-zod annotations', () => {
    describe('x-zod.unmapped fallback', () => {
      ...
      it('should handle maximum depth exceeded', () => {
        ...
        expect(result.warnings.some(w => w.includes('Maximum depth'))).toBe(
          true
        );
      });
    ...
    describe('complex scenarios with mixed success and failure', () => {
